...
function SaveTemplates() {
    ...
    fs.writeFile( __dirname + '/search-form.component.php', search_form_template( php_context ), 'utf8', handleErrors );
    fs.writeFile( __dirname + '/search-form.component.html', search_form_template( angular_context ), 'utf8', handleErrors);
}
...
try{
    ...
    args = neodoc.run(`
        ...
        Usage: search-form._template.js [-x|--execute]
        Options:
